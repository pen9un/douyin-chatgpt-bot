...
平时工作比较忙，没有时间管理，相关接口权限（**抖音官方接口，安全、稳定**）已交由他人使用，**系统地址（非本系统）：** [https://dy.2415.cn/](https://dy.2415.cn/) ，感谢各位支持。

如需本套系统源代码（详见下方系统截图），可和我联系 👇️。
...
**微信交流群**（系统官网及使用方法见群公告，如二维码失效请点 **Star** 耐心等候或提 [Issues](https://github.com/pen9un/douyin-chatgpt-bot/issues) ，会在第一时间更新二维码。进群后先看群公告和机器人使用指令，如有需要加群管理员，需备注 **抖音自媒体系统** 并 **说明加好友原因**）：
